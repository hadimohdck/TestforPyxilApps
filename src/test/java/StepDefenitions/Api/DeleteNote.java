...
public class DeleteNote {
	...
	@When("^(.+) deletes a note with id : (.+)$")
	public void Delete_note(String validuser, String id) {
		...
		test.log(Status.INFO, "header : " + headers);
	...
	@Then("^Delete note returns (.+)$")
	public void DeleteNotereturns(String expectedResponseCode) {
		ExtentTest test = ExtentReportSetup.getTest();
