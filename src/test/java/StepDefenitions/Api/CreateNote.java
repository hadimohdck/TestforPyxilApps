...
public class CreateNote {
	...
	@When("^(.+) provides  title : (.+) for a note in category : (.+) and with description:  (.+)$")
	public void Create_note(String validuser, String title, String category, String description) {
	...
	@Then("^Creat note returns (.+)$")
	public void CreateNotereturns(String expectedResponseCode) {
		ExtentTest test = ExtentReportSetup.getTest();
